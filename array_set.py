...
database = array("i", [12, 3, 4, 2, 3, 14, 7, 8, 3, 45, 5,
                 23, 34, 34, 6, 76, 78, 7, 77, 75, 4, 36, 7, 7, 3, 6, 54])
...
result1 = numb1 | numb2
# ikkita setni bitta qilib beradi takrorlashlarsiz => result1: {7, 10, 11, 45, 77, 14}
print("result1:", result1)

result2 = numb1 & numb2
# ikkita setda mavjud bir xil sonlarni olib beradi => result2: {77, 45}
print("result2:", result2)

result3 = numb1 ^ numb2
# ikkita setda ham mavjud bo'lgan sonlarni tashlab yuboradi qolganlarni bitta arrayda
